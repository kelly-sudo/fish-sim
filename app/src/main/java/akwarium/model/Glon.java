...
public class Glon extends Organizm {
    ...
    private static final double SZANSA_NA_ROZROST = 0.05; // 5% szansy na rozrost w każdej turze
    ...
    public void akcja(Akwarium akwarium) {
        ...
        if (random.nextDouble() < SZANSA_NA_ROZROST) {
            ...
            if (pustePole != null) {
                ...
                System.out.println("Glon (" + this.x + "," + this.y + ") rozmnaża się na (" + pustePole.x + "," + pustePole.y + ").");
            }
        }
    }
